  ...
  <div class="container">
    ...
    <div class="card o-hidden border-0 shadow-lg my-5">
      <div class="card-body p-0">
        ...
        <div class="row">
          <div class="col-lg-5 d-none d-lg-block style="position: relative;  overflow: hidden;"><img src="img/register.jpg" width="100%" alt="LOGIN" style="position: absolute;top: -9999px;  left: -9999px;  right: -9999px;  bottom: -9999px;  margin: auto;">
              </div>
          <div class="col-lg-7">
            <div class="p-5">
